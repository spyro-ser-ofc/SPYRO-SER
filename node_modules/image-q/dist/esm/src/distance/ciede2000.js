...
export class CIEDE2000 extends AbstractDistanceCalculator {
    ...
    static _deg180InRad = degrees2radians(180);
    static _deg30InRad = degrees2radians(30);
    static _deg6InRad = degrees2radians(6);
    static _deg63InRad = degrees2radians(63);
    static _deg275InRad = degrees2radians(275);
    static _deg25InRad = degrees2radians(25);
    _setDefaults() { }
    ...
    static _calculateRT(ahp, aCp) {
        ...
        const delta_theta = CIEDE2000._deg30InRad *
            Math.exp(-(((ahp - CIEDE2000._deg275InRad) / CIEDE2000._deg25InRad) ** 2.0));
